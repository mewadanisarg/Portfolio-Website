  ...
  return (
    <html lang="en" className="!scroll-smooth" suppressHydrationWarning={true}>
      ...
      >
        ...
        <div className="bg-[#dbd7fb] absosulte top-[-1rem] -z-10 left-[-35rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left:[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#676394]"></div>
