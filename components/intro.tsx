...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Nisarg.</span> A{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/nisargmewada/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/mewadanisarg"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          ...
          href="https://www.xing.com/profile/Nisarg_Mewada/web_profiles"
          target="_blank"
        >
          <FaSquareXing />
        </a>
